...
class IpUtils {
	...
	private static function isPrivateIpv6( $ip ) {
		$privateRanges = array(
			 ...
			 */
			array( '::ffff:0.0.0.0', '::ffff:255.255.255.255' ),
			array( '::ffff:0:0', '::ffff:ffff:ffff' ),
			/*
			 * IPv4-translated addresses
			 */
			array( '::ffff:0:0.0.0.0', '::ffff:0:255.255.255.255' ),
			array( '::ffff:0:0:0', '::ffff:0:ffff:ffff' ),
			/*
			 * IPv4/IPv6 translation
			 * https://datatracker.ietf.org/doc/html/rfc6052
			 */
			array( '64:ff9b::0.0.0.0', '64:ff9b::255.255.255.255' ),
			array( '64:ff9b::0:0', '64:ff9b::ffff:ffff' ),
			/*
			 * IPv4/IPv6 translation
			 * https://datatracker.ietf.org/doc/html/rfc8215
			 */
			array( '64:ff9b:1::', '64:ff9b:1:ffff:ffff:ffff:ffff:ffff' ),
			/*
			 * Discard prefix
			 ...
			 */
			array( '2001:20::', '2001:2f:ffff:ffff:ffff:ffff:ffff:ffff' ),
			/*
			 ...
			 */
			array( '5f00::', '5f00:ffff:ffff:ffff:ffff:ffff:ffff:ffff' ),
			/*
			 * Multicast space
			 */
